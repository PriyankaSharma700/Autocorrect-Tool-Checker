A simple, AI-powered spell and grammar checker web app built with Python (Flask), HTML, and CSS.
...
Get instant feedback with corrected spelling, grammar, and proper sentence formatting.# Autocorrect-Tool-Checker
